...
MainModel = "llama3.2"
EditorModel = "llama3.2"
PlanningModel = "llama3.2"
...
def get_planning_response(planning_request):
    ...
    try:
        ...
        planning_response = response['message']['content']
        console.print("\nPlanning Assistant:")
    ...
    while True:
        ...
        if command == 'exit':
            ...
            if command == 'edit':
                ...
                edit_instructions = await get_user_input()
            ...
            planning_request = await get_user_input("Enter your planning request: ")
